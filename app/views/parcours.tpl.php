<main class="cv" id="top">
    ...
    <nav> 
       ...
       <div class="custom-shape-divider-bottom-1619618614">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <section id="formation" class="cv-section">
            ...
            <div><i class="scroll fas fa-chevron-down" data-target ="experiences"></i></div>
            <div class="custom-shape-divider-bottom-1619618614">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M598.97 114.72L0 0 0 120 1200 120 1200 0 598.97 114.72z" class="shape-fill"></path>
    </svg>
        ...
        <section id="experiences" class="cv-section">
           ...
           <div><i class="scroll fas fa-chevron-down" data-target="competences"><a href="#competences"></a></i></div>
           <div class="custom-shape-divider-bottom-1619618614">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M598.97 114.72L0 0 0 120 1200 120 1200 0 598.97 114.72z" class="shape-fill"></path>
    </svg>
        ...
        <section id="competences" class="cv-section">
            ...
            <div class="cv-section__container skills">
                <div class="skills-section">
                    ...
                    <ul>
                        <?php foreach($viewVars['badges'] as $badge) : ?>
                ...
                <div class="skills-section">
                    ...
                    <div class="cv-section__infos skills-section__infos">
                    <ul>
                        <?php foreach($viewVars['langues'] as $langue) : ?>
                            <li>
           ...
           <div><i class="fas fa-chevron-down scroll" data-target='divers'></i></div>
           <div class="custom-shape-divider-bottom-1619618614">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M598.97 114.72L0 0 0 120 1200 120 1200 0 598.97 114.72z" class="shape-fill"></path>
    </svg>
        ...
        <section id="divers" class="cv-section">
            ...
            <div class="cv-section__container">
                ...
                <div class="clear"></div>
                <div class="cv-section__infos right">
                    <i class="fas fa-fish"></i> Intérêts : vélo, plongée, voyages
                    <div class="cv-section__timeline"></div>
                </div>
                <div class="clear"></div>
            </div>
